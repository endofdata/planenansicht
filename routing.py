...
EDIT_USERRIGHTS_ACTION = "edit_user_rights"
...
EDIT_USER_ENDPOINT = ADMIN_API_AREA + "/" + EDIT_USER_ACTION
EDIT_USERRIGHTS_ENDPOINT = ADMIN_API_AREA + "/" + EDIT_USERRIGHTS_ACTION
DELETE_USER_ENDPOINT = ADMIN_API_AREA + "/" + DELETE_USER_ACTION
...
ADMIN_LIST_USERS = ADMIN_API_NAME + "." + LIST_USERS_ACTION
ADMIN_ADD_USER = ADMIN_API_NAME + "." + ADD_USER_ACTION
ADMIN_EDIT_USER = ADMIN_API_NAME + "." + EDIT_USER_ACTION
ADMIN_EDIT_USERRIGHTS = ADMIN_API_NAME + "." + EDIT_USERRIGHTS_ACTION
ADMIN_DELETE_USER = ADMIN_API_NAME + "." + DELETE_USER_ACTION
...
class RoutingHelper:
	def __init__(self):
		...
		self.EDIT_USER_ENDPOINT = EDIT_USER_ENDPOINT
		self.EDIT_USERRIGHTS_ENDPOINT = EDIT_USERRIGHTS_ENDPOINT
		self.DELETE_USER_ENDPOINT = DELETE_USER_ENDPOINT
